...
$get_product = get_product($con,'', null, $product_id, null, null);
?>
                    ...
                    <div class="row">
                                ...
                                <div class="product__big__images">
                                    <div class="portfolio-full-image tab-content">
                                        <div role="tabpanel" class="tab-pane fade in active" id="img-tab-1">
                                            <img src="<?php echo SITE_PRODUCT_IMAGE.$get_product[0]['image']?>" alt="<?php echo $get_product[0]['name']; ?>">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12 smt-40 xmt-40">
                            <div class="ht__product__dtl">
                                ...
                                <h6>Model: <span><?php echo $get_product[0]['short_desc']; ?></span></h6>
                                <ul class="rating">
                                ...
                                <div class="ht__pro__desc">
                                    ...
                                    <div class="sin__desc">
                                        ...
                                        <select id="qty" style="width: 60px; margin-left: 8px;">
                                            <option>1</option>
                                            <option>2</option>
                                            <option>3</option>
                                            <option>4</option>
                            ...
                            <div>
                                <a href="#" class="fr__btn" style="margin-top: 8px" onclick="add_to_cart(<?php echo $get_product[0]['id'];?>, 'add')">Add To Cart</a>
                            </div>
                        </div>
                    </div>
                </div>
